...
2016年6月21日(火)
AJACS前橋@群馬大学 医学部 情報処理演習室Ａ（昭和キャンパス共用施設棟3階）  
...
講習会全体のプログラムは[こちら](http://events.biosciencedbc.jp/training/ajacs59)です。  
...
#### 受講前アンケートにご協力いただき、ありがとうございます (回答数 40)
...
|:--|--:|:--:|
|これから実験をする・したい|8 名|20 %|
|公共データを活用する・したい|11 名|28 %|
|既に持っている|18 名|45 %|
|大規模発現解析の予定はない|3 名|7 %|
...
- ウェブサイトへのアクセスの仕方から結果の解釈まで、操作の一挙手一投足がわかります。
    ...
    - ![https://gyazo.com/382d3995a1bd4e5d893779b53ceffffd](https://i.gyazo.com/382d3995a1bd4e5d893779b53ceffffd.png)
